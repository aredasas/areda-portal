 ...
 * misma convención con la que el backend guarda dueDate de tareas y
 * vencimientos. Usar SIEMPRE esta función (nunca
 * `new Date(Date.UTC(now.getUTCFullYear(), ...))` directo) para calcular
 * "hoy" en cualquier comparación de vencimientos en el frontend — de lo
 * contrario, el día cambia a las 7:00pm hora Colombia (medianoche UTC) en
 * vez de a medianoche Colombia, y todo lo que vence "mañana" se muestra
 * como que vence "hoy" durante esas 5 horas cada noche. */
